...
export const minecraftAuthErrors: MinecraftAuthError[] = [
	{
		...
		whatHappened:
			'Your saved Microsoft sign-in token has expired or was revoked, so PackForge cannot refresh your Minecraft session.',
		stepsToFix: [
			'Sign out of the affected Minecraft account in PackForge',
	...
	},
	{
		...
		stepsToFix: [
			...
			'Restart PackForge after waiting',
	...
	},
	{
		...
		whatHappened:
			"Minecraft's authentication service is returning a server error, so PackForge cannot finish signing you in right now.",
		stepsToFix: [
	...
	},
	{
		...
		stepsToFix: [
			...
			'Try signing in to PackForge again',
		],
	},
	{
		matches: (message) =>
		...
		whatHappened:
			'PackForge could not connect to a Microsoft, Xbox, or Minecraft service needed for sign-in. This is usually caused by a local network, DNS, proxy, firewall, hosts file, VPN, or antivirus issue.',
		stepsToFix: [
			'Restart PackForge and try signing in again',
			'Check that your internet connection is working',
			'Allow PackForge through your firewall, antivirus, proxy, VPN, and hosts file rules',
	...
	},
	{
		...
		whatHappened:
			'Xbox services rejected the request to authorize this account for Minecraft services, but did not return a specific account restriction that PackForge recognizes.',
		stepsToFix: [
			'Sign in with the <a href="https://www.minecraft.net/en-us/download">official Minecraft Launcher</a>',
